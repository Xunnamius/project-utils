...
- need to add another step to release.config.js that replaces all monorepo
  package dependencies (dep, dev, peer, etc) in all package.json files with the
  version that is about to be published, commits that, and then commits a revert
  that changes these back to their file://... urls. Does this need coordination
  with semantic-release-plugin? Add a "why do it this way?" section that talks
  about a package.json at the publish tag that matches what has been published
  to npm.
...
```bash
npm install --save-dev @projector-js/config-semantic-release-atam
```
...
[x-badge-downloads-image]:
  https://img.shields.io/npm/dm/@projector-js/config-semantic-release-atam?style=flat-square
  'Number of times this package has been downloaded per month'
[x-badge-lastcommit-image]:
  https://img.shields.io/github/last-commit/xunnamius/projector?style=flat-square
  'Latest commit timestamp'
[x-badge-license-image]:
  https://img.shields.io/npm/l/@projector-js/config-semantic-release-atam?style=flat-square
  "This package's source license"
[x-badge-license-link]: https://github.com/Xunnamius/projector/blob/main/LICENSE
[x-badge-npm-image]:
  https://xunn.at/npm-pkg-version/@projector-js/config-semantic-release-atam
  'Install this package using npm or yarn!'
[x-badge-npm-link]:
  https://www.npmjs.com/package/@projector-js/config-semantic-release-atam
