...
[badge-license]:
  https://img.shields.io/npm/l/@projector-js/config-semantic-release-atam
...
[badge-npm]:
  https://api.ergodark.com/badges/npm-pkg-version/@projector-js/config-semantic-release-atam
...
[badge-size]:
  https://badgen.net/bundlephobia/minzip/@projector-js/config-semantic-release-atam
[badge-tree-shaking]:
  https://badgen.net/bundlephobia/tree-shaking/@projector-js/config-semantic-release-atam
  'Is this package optimized for Webpack?'
[link-bundlephobia]:
  https://bundlephobia.com/result?p=@projector-js/config-semantic-release-atam
