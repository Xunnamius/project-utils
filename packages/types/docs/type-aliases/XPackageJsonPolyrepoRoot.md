...
[@-xun/project-types](../README.md) / XPackageJsonPolyrepoRoot

# Type Alias: XPackageJsonPolyrepoRoot

> **XPackageJsonPolyrepoRoot** = `Omit`\<[`XPackageJson`](XPackageJson.md), `"workspaces"`\>

Defined in: [index.ts:524](https://github.com/Xunnamius/projector/blob/2ee6352d2d20d1cac2a947b31a478b43bbb1165b/packages/types/src/index.ts#L524)
