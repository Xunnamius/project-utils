...
- doctoc and remark should ignore whichever files prettier is ignoring (does
  ...
  .prettierignore directly). That is: use fast-glob to interpret a shared glob
  and then pass the same files to each program.
...
[x-badge-downloads-image]:
  https://img.shields.io/npm/dm/@projector-js/plugin-format?style=flat-square
  'Number of times this package has been downloaded per month'
[x-badge-lastcommit-image]:
  https://img.shields.io/github/last-commit/xunnamius/projector?style=flat-square
  'Latest commit timestamp'
[x-badge-license-image]:
  https://img.shields.io/npm/l/@projector-js/plugin-format?style=flat-square
  "This package's source license"
[x-badge-license-link]: https://github.com/Xunnamius/projector/blob/main/LICENSE
[x-badge-npm-image]:
  https://xunn.at/npm-pkg-version/@projector-js/plugin-format
  'Install this package using npm or yarn!'
[x-badge-npm-link]: https://www.npmjs.com/package/@projector-js/plugin-format
