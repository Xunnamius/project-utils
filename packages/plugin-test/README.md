...
- Calls codecov with the appropriate flags for monorepos. Codecov coverage data
  is uploaded after all unit and integration tests are run together. Only one
  flag used at once, and they are used automatically by this plugin depending on
  context data (no manual input required). Need to specify `-f` flag (and store
  coverage locally/per sub-root) as well as `-F` Flag flag. Use automatic flag
  management. One flag per upload type; flags will look like `pkgNameOrId` for
  monorepos. Polyrepos should not use flags. See:
...
```bash
npm install --save-dev @projector-js/plugin-test
```
...
[x-badge-downloads-image]:
  https://img.shields.io/npm/dm/@projector-js/plugin-test?style=flat-square
  'Number of times this package has been downloaded per month'
[x-badge-lastcommit-image]:
  https://img.shields.io/github/last-commit/xunnamius/projector?style=flat-square
  'Latest commit timestamp'
[x-badge-license-image]:
  https://img.shields.io/npm/l/@projector-js/plugin-test?style=flat-square
  "This package's source license"
[x-badge-license-link]: https://github.com/Xunnamius/projector/blob/main/LICENSE
[x-badge-npm-image]:
  https://xunn.at/npm-pkg-version/@projector-js/plugin-test
  'Install this package using npm or yarn!'
[x-badge-npm-link]: https://www.npmjs.com/package/@projector-js/plugin-test
