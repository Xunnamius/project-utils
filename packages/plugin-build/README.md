...
- build-docs config\['plugin-build'].docs.entry can be a simple path, an array
  of paths, a glob path, or an array of glob paths
- actually, use cosmiconfig for config
- all plugin-X CLI tools need to have the ability to do project-wide stuff or
  just package-scoped stuff, and monorepo package's package.json must be
  configured to reach back to the root package.json but pass the appropriate
  info/flags
...
```bash
npm install --save-dev @projector-js/plugin-build
```
...
[x-badge-downloads-image]:
  https://img.shields.io/npm/dm/@projector-js/plugin-build?style=flat-square
  'Number of times this package has been downloaded per month'
[x-badge-lastcommit-image]:
  https://img.shields.io/github/last-commit/xunnamius/projector?style=flat-square
  'Latest commit timestamp'
[x-badge-license-image]:
  https://img.shields.io/npm/l/@projector-js/plugin-build?style=flat-square
  "This package's source license"
[x-badge-license-link]: https://github.com/Xunnamius/projector/blob/main/LICENSE
[x-badge-npm-image]:
  https://xunn.at/npm-pkg-version/@projector-js/plugin-build
  'Install this package using npm or yarn!'
[x-badge-npm-link]: https://www.npmjs.com/package/@projector-js/plugin-build
