...
[@-xun/project](../../README.md) / [src](../README.md) / gatherPseudodecoratorEntriesFromFiles
...
Defined in: packages/graph/dist/packages/graph/src/analysis/gather-pseudodecorator-entries-from-files.d.ts:151
