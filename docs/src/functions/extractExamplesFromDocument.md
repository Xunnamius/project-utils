...
[@-xun/project](../../README.md) / [src](../README.md) / extractExamplesFromDocument
...
Defined in: packages/fs/dist/packages/fs/src/system/extract-examples-from-document.d.ts:61
...
Defined in: packages/fs/dist/packages/fs/src/system/extract-examples-from-document.d.ts:64
