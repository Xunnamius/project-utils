...
> **readXPackageJsonAtRoot**(...`args`): `Promise`\<[`XPackageJson`](../type-aliases/XPackageJson.md)\>

Defined in: packages/fs/dist/packages/fs/src/system/read-xpackage-json-at-root.d.ts:44
